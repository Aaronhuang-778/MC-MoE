...
from transformers import default_data_collator,PreTrainedTokenizer
...
def build_calib_loader(dataset: str, tokenizer: PreTrainedTokenizer, max_block_size: int, n_blocks_for_stat: int, batch_size: int, num_workers: int, seed: int = 41):
